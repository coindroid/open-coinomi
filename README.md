...
* in build.gradle the package from "com.coindroid.coinomi" to "com.coinomi.wallet"
* in AndroidManifest.xml the android:icon to "ic_launcher" and all "com.coindroid.coinomi.*"  to "com.coinomi.wallet.*"
